export const uiChrome = {
  overlaySurface:
    "rounded-lg border border-border/70 bg-popover/95 text-popover-foreground shadow-[0_20px_48px_rgba(15,23,42,0.16)] backdrop-blur-2xl dark:bg-popover/92 dark:shadow-[0_24px_56px_rgba(0,0,0,0.55)]",
...
export const uiControl = {
  ...
  listItem: "rounded-lg px-4 py-2 text-sm",
} as const
