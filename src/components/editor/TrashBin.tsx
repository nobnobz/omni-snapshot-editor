        ...
        <div className={cn(editorSurface.card, "mt-8 overflow-hidden animate-in fade-in slide-in-from-bottom-2 duration-300")}>
            <div className="p-5 sm:p-6">
                    <button
                        ...
                        className={cn("flex w-full items-center justify-between gap-3 rounded-xl text-left transition-colors hover:bg-muted/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30", isOpen && "mb-4")}
