...
export const editorLayout = {
  dialogContent:
    "fixed left-1/2 top-[calc(0.5rem+env(safe-area-inset-top))] w-[98vw] max-w-[calc(100%-0.5rem)] -translate-x-1/2 rounded-2xl border border-slate-200 bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(248,250,252,0.95))] p-4 shadow-[0_24px_56px_rgba(15,23,42,0.2)] backdrop-blur-2xl focus:outline-none z-50 transition-[background-color,border-color,color,box-shadow,opacity,transform] duration-200 ease-out dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(10,12,18,0.98),rgba(7,9,14,0.99))] dark:shadow-[0_24px_56px_rgba(0,0,0,0.64)] h-auto max-h-[calc(100dvh-1rem-env(safe-area-inset-top)-env(safe-area-inset-bottom))] flex flex-col overflow-hidden sm:top-1/2 sm:-translate-y-1/2 sm:w-auto sm:max-h-[92dvh] sm:rounded-xl sm:max-w-6xl",
  sectionCard:
