...
export const editorLayout = {
  dialogContent:
    "fixed left-1/2 top-1/2 w-[calc(100%-2rem)] max-w-[calc(100%-2rem)] -translate-x-1/2 -translate-y-1/2 rounded-2xl border border-slate-200 bg-white p-4 shadow-[0_24px_56px_rgba(15,23,42,0.22)] backdrop-blur-2xl focus:outline-none z-50 transition-[background-color,border-color,color,box-shadow,opacity,transform] duration-200 ease-out dark:border-white/10 dark:bg-[#090b11] dark:shadow-[0_24px_56px_rgba(0,0,0,0.64)] h-auto max-h-[calc(100dvh-2rem-env(safe-area-inset-top)-env(safe-area-inset-bottom))] flex flex-col overflow-y-auto custom-scrollbar sm:w-auto sm:max-h-[92dvh] sm:rounded-xl sm:max-w-6xl sm:w-[94vw] sm:bg-[linear-gradient(180deg,rgba(255,255,255,0.98),rgba(248,250,252,0.95))] sm:dark:bg-[linear-gradient(180deg,rgba(10,12,18,0.97),rgba(7,9,14,0.99))]",
  sectionCard:
