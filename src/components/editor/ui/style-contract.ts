...
export const editorLayout = {
  dialogContent:
    "fixed left-1/2 top-1/2 w-[96vw] max-w-[calc(100%-1rem)] -translate-x-1/2 -translate-y-1/2 rounded-xl border border-slate-200/80 bg-[linear-gradient(180deg,rgba(255,255,255,0.9),rgba(248,250,252,0.82))] p-4 shadow-[0_24px_56px_rgba(15,23,42,0.16)] backdrop-blur-xl focus:outline-none z-50 transition-[background-color,border-color,color,box-shadow,opacity,transform] duration-200 ease-out dark:border-white/10 dark:bg-[linear-gradient(180deg,rgba(18,18,22,0.95),rgba(10,10,14,0.98))] dark:shadow-[0_24px_56px_rgba(0,0,0,0.56)] h-[calc(100dvh-1rem-env(safe-area-inset-top)-env(safe-area-inset-bottom))] max-h-[calc(100dvh-1rem-env(safe-area-inset-top)-env(safe-area-inset-bottom))] sm:h-auto sm:max-h-[92dvh] flex flex-col overflow-hidden",
  sectionCard:
