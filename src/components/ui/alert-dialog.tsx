...
function AlertDialogHeader({
  ...
  return (
    <div
      ...
      className={cn(
        "grid w-full grid-rows-[auto_1fr] justify-items-start gap-1.5 text-left has-data-[slot=alert-dialog-media]:grid-rows-[auto_auto_1fr] has-data-[slot=alert-dialog-media]:gap-x-6 has-data-[slot=alert-dialog-media]:justify-items-start has-data-[slot=alert-dialog-media]:text-left sm:group-data-[size=default]/alert-dialog-content:has-data-[slot=alert-dialog-media]:grid-rows-[auto_1fr]",
        className
      )}
      {...props}
    />
...
function AlertDialogTitle({
  ...
  return (
    <AlertDialogPrimitive.Title
      ...
      className={cn(
        "w-full text-left text-lg font-semibold sm:group-data-[size=default]/alert-dialog-content:group-has-data-[slot=alert-dialog-media]/alert-dialog-content:col-start-2",
        className
      )}
      {...props}
    />
...
function AlertDialogDescription({
  ...
  return (
    <AlertDialogPrimitive.Description
      ...
      className={cn("w-full text-left text-sm text-muted-foreground", className)}
      {...props}
    />
  )
}
