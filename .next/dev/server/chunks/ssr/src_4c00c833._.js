...
;
;
function SortableItem({ id, displayName, isEnabled, onToggle, onRename }) {
    const { attributes, listeners, setNodeRef, transform, transition, isDragging } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$dnd$2d$kit$2f$sortable$2f$dist$2f$sortable$2e$esm$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useSortable"])({
        id
    });
    const style = {
...
function SortableList({ itemsList, customNames, disabledCatalogs, onUpdateOrder, onRenameCatalog, onToggleCatalog }) {
...
;
function MainEditor() {
    const { currentValues, fileName, exportConfig, resetAll } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$context$2f$ConfigContext$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useConfig"])();
...
//# sourceMappingURL=src_4c00c833._.js.map