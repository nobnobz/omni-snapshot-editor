...
function resolveCatalogName(id, customNames = {}) {
    ...
    const fallbackName = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2d$fallbacks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CATALOG_FALLBACKS"][id] || __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$catalog$2d$fallbacks$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CATALOG_FALLBACKS"][baseId];
    if (fallbackName) {
...
function ensureCatalogPrefix(id, name) {
...
function createSubgroup(name, targetMainGroupUuid, imageUrl, initialCatalogs = [], state) {
    ...
    const normalizedCatalogs = initialCatalogs.map((id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ensureCatalogPrefix"])(id, (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resolveCatalogName"])(id, draft.custom_catalog_names || {})));
...
function importGroups(payload, state) {
    ...
    Object.keys(payload.subgroups).forEach((name)=>{
        ...
        const normalized = (sg.catalogs || []).map((id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ensureCatalogPrefix"])(id, (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resolveCatalogName"])(id, draft.custom_catalog_names || {})));
...
const ConfigProvider = ({ children })=>{
    ...
    const [isSyntheticSession, setIsSyntheticSession] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const loadConfig = (config, fn = "omni-config.json")=>{
        ...
        if (extractedCatalogs.length === 0) {
            ...
            extractedCatalogs = Array.from(allIds).map((id)=>{
                ...
                const finalId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ensureCatalogPrefix"])(id, name);
                return {
                    id: finalId,
                    name: name,
        ...
        const includedKeys = config.includedKeys || [];
    ...
    const addCatalogGroup = (name, targetMainGroupUuid, imageUrl, initialCatalogs = [])=>{
        ...
        const normalized = initialCatalogs.map((id)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ensureCatalogPrefix"])(id, (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["resolveCatalogName"])(id, currentValues.custom_catalog_names || {})));
        setCurrentValues((prev)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$mutations$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createSubgroup"])(name, targetMainGroupUuid, imageUrl, normalized, prev));
    };
    ...
    const addManifestCatalog = (catalog)=>{
        const finalId = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$utils$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ensureCatalogPrefix"])(catalog.id, catalog.name);
        setCatalogs((prev)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__cf5c45e2._.js.map